...
Für alle Implementierungsaufgaben in dieses Verzeichnis wechseln. Dort gibt es eine eigene `CLAUDE.md` (falls vorhanden) mit Build-Befehlen und technischer Architektur.
